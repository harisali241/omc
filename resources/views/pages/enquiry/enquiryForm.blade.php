        ...
        <form class="form-horizontal" role="form" action="{{ route('enquiryForm.store') }}" method="POST"/>
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-3 col-xs-6">
                    <label style="width:300px;padding-left:10px;padding-right: 10px;"><img src="{!! captcha_url() !!}" alt="captcha"></label>
                </div>
                <div class="col-md-4 col-sm-3 col-xs-6">
                    <input type="text" name="captcha" autocomplete="off" class="form-control" style="height:60px;width:200px;">
                </div>
            </div>
